...
function getChipLabel(questionId, value) {
...
function AnswerChip({ questionId, value, icon, onClick, isEditing }) {
  return (
    <button
      onClick={onClick}
...
function QuestionSection({ question, index, state, answer, onAnswer, onEdit, sectionRef }) {
...
// Result section
function ResultSection({ result, show, answers }) {
