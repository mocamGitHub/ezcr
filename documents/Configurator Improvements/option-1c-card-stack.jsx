...
function QuestionCard({ question, index, isActive, isBehind, behindIndex, onAnswer, isExiting, exitDirection }) {
...
function ResultCard({ result, show }) {
              ...
              {visibleCards.slice().reverse().map((question, reverseIndex) => {
                ...
                return (
                  <QuestionCard
                    ...
                    isBehind={actualIndex > currentIndex}
