...
function QuickConfigurator({ onAddToCart }) {
...
function CheckoutFitVerification({ product, onContinue, onBack }) {
  ...
  const [fitStatus, setFitStatus] = useState(null); // null | 'checking' | 'verified' | 'mismatch'
...
export default function Option3CMeasurementsAtCheckout() {
  const [stage, setStage] = useState('configurator'); // 'configurator' | 'checkout'
