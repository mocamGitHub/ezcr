...
const EXACT_QUESTIONS: Question[] = [
  {
    id: 'truckMake',
...
function calculateRecommendation(answers: Record<string, string>, isExact = false): Result {
  // Weight check
...
function EntrySelection({ onSelectPath }: { onSelectPath: (path: 'quick' | 'exact') => void }) {
  return (
...
// Quick Check flow
function QuickCheckFlow({ onUpgrade }: { onUpgrade: () => void }) {
    ...
    return (
      <div className="text-center">
        ...
        <p className="text-amber-500/70 text-sm mb-6">
          This is a preliminary recommendation. We&apos;ll verify exact fit before shipping.
        </p>
    ...
    return (
      <div className="text-center">
        ...
        <div className="bg-zinc-800/50 rounded-lg p-4 mb-6">
          <p className="text-white font-medium">Fit Guarantee</p>
      ...
      {currentQuestion?.type === 'input' && (
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-6 py-4 bg-amber-500 hover:bg-amber-400 text-black font-bold rounded-lg"
          >
            Next
          </button>
        </div>
...
export default function Option3ATwoEntryPoints() {
  const [selectedPath, setSelectedPath] = useState<'quick' | 'exact' | null>(null)
    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-900 to-black py-16 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 shadow-2xl">
          ...
          {selectedPath === 'quick' && (
            <QuickCheckFlow onUpgrade={handleUpgrade} />
          )}
